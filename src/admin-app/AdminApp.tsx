...
import { initialCategories } from '../shared/data/categories';
import { initialBanners } from '../shared/data/banners';
import { initialTrends } from '../shared/data/trends';
import { initialPricingSettings } from '../shared/utils/pricing';
import Toast from '../components/Toast';
import { Product, Category, Banner, TrendCampaign, PricingSettings } from '../shared/types';
...
export default function AdminApp() {
  ...
  const [trendCampaigns, setTrendCampaigns] = useState<TrendCampaign[]>(initialTrends);
