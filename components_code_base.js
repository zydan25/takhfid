...
/* === CUSTOMER MODALS & ADMIN MANAGERS === */

const GiftCardsModal = ({ isOpen, onClose, userProfile, onShowToast, onOpenWallet }) => {
  const [perks, setPerks] = S.useState(() => window.__getCustomerPerks(userProfile ? userProfile.id || userProfile.uid : null));
  const [redeemCode, setRedeemCode] = S.useState("");
  const [copiedCode, setCopiedCode] = S.useState(null);

  S.useEffect(() => {
    const handler = () => {
      setPerks(window.__getCustomerPerks(userProfile ? userProfile.id || userProfile.uid : null));
    };
  ...
  const giftCards = perks.filter(p => p.type === "gift_card" || p.type === "wallet_credit");

  const handleRedeem = (e) => {
    e && e.preventDefault();
    if (!redeemCode.trim()) {
      onShowToast && onShowToast("يرجى إدخال رمز بطاقة الهدية", "error");
      return;
    }
  ...
  const copyCode = (code) => {
    ...
    setCopiedCode(code);
    onShowToast && onShowToast(`تم نسخ الرمز: ${code} 📋`, "info");
  ...
  return r.jsx("div", {
    ...
    children: r.jsxs("div", {
      ...
      children: [
        r.jsxs("div", {
          className: "p-4 border-b border-slate-100 flex items-center justify-between bg-gradient-to-r from-rose-50/70 via-white to-amber-50/70",
          children: [
            r.jsxs("div", {
              ...
              children: [
                ...
                r.jsxs("div", {
                  children: [
                    r.jsx("h3", { className: "text-base font-black text-slate-900", children: "بطاقات الهدايا والمكافآت" }),
                    r.jsx("p", { className: "text-[11px] text-slate-500 font-medium", children: "استبدل بطاقتك واشحن رصيد محفظتك للتسوق" })
                  ]
                })
              ]
            }),
        ...
        r.jsxs("div", {
          ...
          children: [
            r.jsxs("form", {
              ...
              children: [
                r.jsx("label", { className: "block text-xs font-bold text-slate-700 mb-1.5", children: "هل لديك رمز بطاقة هدية؟" }),
                r.jsxs("div", {
                  ...
                  children: [
                    r.jsx("input", {
                      ...
                      placeholder: "أدخل رمز البطاقة هنا (مثال: GIFT5000)",
            ...
            r.jsxs("div", {
              ...
              children: [
                r.jsx("h4", { className: "text-xs font-black text-slate-800", children: "البطاقات والمكافآت المتاحة لك" }),
                r.jsx("span", { className: "text-[11px] text-slate-500 font-bold", children: `${giftCards.length} بطاقة` })
              ]
            }),
            giftCards.length === 0 ? r.jsxs("div", {
              className: "text-center py-8 text-slate-400 space-y-2",
              children: [
                r.jsx(Y0, { className: "w-10 h-10 mx-auto text-slate-300 stroke-[1.5]" }),
                r.jsx("p", { className: "text-xs font-bold text-slate-500", children: "لا توجد بطاقات هدايا غير مستخدمة حالياً" }),
                r.jsx("p", { className: "text-[11px] text-slate-400", children: "تابع العروض الحصرية أو تواصل مع الدعم الفني للحصول على بطاقات هدايا ترويجية!" })
              ]
            }) : r.jsx("div", {
              className: "space-y-2.5",
              children: giftCards.map((card) => {
                const uid = userProfile ? userProfile.id || userProfile.uid : "guest_user";
                const isRedeemed = Array.isArray(card.redeemedBy) && card.redeemedBy.includes(uid);
                const currName = card.currency === "SAR" ? "ريال سعودي" : card.currency === "USD" ? "دولار" : "ريال يمني";
                return r.jsxs("div", {
                  key: card.id,
                  ...
                  children: [
                    r.jsxs("div", {
                      ...
                      children: [
                        r.jsxs("div", {
                          children: [
                            r.jsx("h5", { className: "text-xs font-black text-slate-900", children: card.title }),
                            r.jsx("p", { className: "text-[10.5px] text-slate-500 font-medium mt-0.5", children: card.description || "صالحة للاستخدام في شحن المحفظة" })
                          ]
                        }),
                        r.jsxs("div", {
                          className: "text-right shrink-0",
                          children: [
                            r.jsxs("span", { className: "text-base font-black text-rose-600 block", children: [Number(card.amount || card.discountValue || 0).toLocaleString(), " ", currName] }),
                            card.expiresAt && r.jsxs("span", { className: "text-[9.5px] text-slate-400 font-medium block", children: ["تنتهي: ", card.expiresAt] })
                          ]
                        })
                      ]
                    }),
                        ...
                        r.jsxs("div", {
                          ...
                          children: [
                            r.jsx("button", {
                              ...
                              children: copiedCode === card.code ? "تم النسخ ✓" : "نسخ الرمز"
                            }),
                            !isRedeemed && r.jsx("button", {
                              type: "button",
                              onClick: () => {
                                setRedeemCode(card.code);
                                const res = window.__redeemPerk(card.code, uid);
                                if (res.success) {
                                  onShowToast && onShowToast(res.message, "success");
                                  setPerks(window.__getCustomerPerks(uid));
                                } else {
...
const CouponsModal = ({ isOpen, onClose, userProfile, onShowToast, onApplyCoupon }) => {
  ...
  const copyCode = (code) => {
    navigator.clipboard.writeText(code);
    setCopiedCode(code);
    onShowToast && onShowToast(`تم نسخ الكوبون: ${code} 🏷️`, "info");
    setTimeout(() => setCopiedCode(null), 2000);
  };

  const applyCoupon = (code) => {
    localStorage.setItem("applied_coupon_code_v1", code);
    onShowToast && onShowToast(`تم تفعيل الكوبون "${code}" بنجاح! سيتم تطبيق الخصم في السلة ✨`, "success");
              ...
              children: [
                ...
                r.jsxs("div", {
                  children: [
                    ...
                    r.jsx("p", { className: "text-[11px] text-slate-500 font-medium", children: "أقوى التخفيضات والكوبونات المتاحة لطلبك" })
                  ]
                })
              ]
            }),
          ...
          children: [
            coupons.length === 0 ? r.jsxs("div", {
              ...
              children: [
                ...
                r.jsx("p", { className: "text-xs font-bold text-slate-500", children: "لا توجد كوبونات حالياً" })
              ]
            }) : coupons.map((c) => r.jsxs("div", {
              key: c.id,
              ...
              children: [
                r.jsxs("div", {
                  ...
                  children: [
                    ...
                    r.jsx("span", {
                      className: "px-2.5 py-1 bg-amber-500 text-white rounded-full text-xs font-black shrink-0 shadow-2xs",
...
const CustomerPerksAdminManager = ({ users = [], onShowToast, onClose }) => {
  ...
  const [expiresAt, setExpiresAt] = S.useState("2026-12-31");
  ...
  const generateCode = () => {
    const prefix = perkType === "gift_card" ? "GIFT" : perkType === "coupon" ? "COUPON" : "BONUS";
  ...
  const handleCreatePerk = (e) => {
    e.preventDefault();
    if (!title.trim()) {
      onShowToast && onShowToast("يرجى إدخال عنوان الهدية أو الكوبون", "error");
      return;
    }
    ...
    onShowToast && onShowToast(`تم إنشاء وإصدار "${title.trim()}" بنجاح! 🎁✨`, "success");
    setTitle("");
    setCode("");
  };
    ...
    children: [
        ...
        children: [
          r.jsxs("div", {
            ...
            children: [
              ...
              r.jsxs("div", {
                children: [
                  r.jsx("h4", { className: "text-xs font-black text-slate-900", children: "إدارة الهدايا والمحافظ والكوبونات" }),
                  r.jsx("p", { className: "text-[10px] text-slate-500", children: "إصدار بطاقات هدايا وكوبونات وشحن محافظ العملاء" })
                ]
              })
            ]
          }),
          r.jsx("span", { className: "text-[10px] font-bold px-2 py-0.5 bg-white text-slate-700 rounded-full border border-slate-200", children: `${perks.length} بطاقة وكوبون` })
        ]
      }),
      r.jsxs("div", {
      ...
      tab === "issue" && r.jsxs("form", {
        ...
        children: [
          r.jsxs("div", {
            children: [
              r.jsx("label", { className: "block font-bold text-slate-700 mb-1", children: "نوع الإهداء / المكافأة:" }),
              r.jsxs("select", {
                value: perkType,
                ...
                children: [
                  ...
                  r.jsx("option", { value: "coupon", children: "كود خصم (نسبة مئوية من قيمة السلة)" }),
                  r.jsx("option", { value: "wallet_credit", children: "رصيد مباشر" })
                ]
              })
            ]
          }),
          ...
          r.jsxs("div", {
            children: [
              r.jsx("label", { className: "block font-bold text-slate-700 mb-1", children: "عنوان البطاقة / الكوبون:" }),
              r.jsx("input", {
                type: "text",
                value: title,
                onChange: (e) => setTitle(e.target.value),
                placeholder: "مثال: بطاقة هدية رمضان 10,000 ريال أو خصم 20%",
                className: "w-full p-2 bg-slate-50 border border-slate-200 rounded-xl font-bold"
              })
            ]
          }),
          ...
          r.jsxs("div", {
            children: [
              r.jsxs("div", {
                ...
                children: [
                  r.jsx("label", { className: "font-bold text-slate-700", children: "رمز الكود:" }),
                  r.jsx("button", {
                    type: "button",
          ...
          r.jsxs("div", {
            children: [
              r.jsx("label", { className: "block font-bold text-slate-700 mb-1", children: "تاريخ الانتهاء:" }),
              r.jsx("input", {
                type: "date",
                value: expiresAt,
          ...
          r.jsx("button", {
            ...
            children: "إصدار البطاقة / الكوبون الآن"
          })
        ]
      }),
      ...
      tab === "list" && r.jsxs("div", {
        ...
        children: [
          perks.length === 0 ? r.jsx("p", {
            ...
            children: "لا توجد بطاقات أو كوبونات مصدرة"
          }) : perks.map((p) => r.jsxs("div", {
            key: p.id,
                ...
                children: [
                  r.jsxs("div", {
                    ...
                    children: [
                      ...
                      r.jsx("span", {
                        className: "px-2 py-0.5 rounded-full text-[9px] font-bold bg-slate-100 text-slate-700",
                        children: p.type === "gift_card" ? "بطاقة هدية" : p.type === "coupon" ? "كوبون" : "رصيد"
                      })
                    ]
                  }),
                  r.jsxs("div", {
                    ...
                    children: [
                      r.jsxs("span", { className: "font-mono font-bold text-slate-800 bg-slate-50 px-1.5 rounded border border-slate-200", children: [p.code] }),
                      r.jsxs("span", { children: ["المبلغ/الخصم: ", p.type === "coupon" ? `${p.discountValue}%` : `${Number(p.amount).toLocaleString()} ${p.currency}`] }),
                      p.expiresAt && r.jsxs("span", { children: ["انتهاء: ", p.expiresAt] })
                    ]
                  })
                ]
              }),
